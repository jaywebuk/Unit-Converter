...
<body class="d-flex flex-column h-100">
		...
		<div class="container-fluid p-0">
			<header class="main-header d-flex justify-content-between px-3">
				...
				<section
					...
					<a class="" href="https://www.jrwebdev.co.uk/" title="My Website" data-link="jnrwebdev" target="_blank">
						<img class="mb-2 mt-sm-0" src="img/site_logo.png" alt="My Website">
					</a>
					<a class="mb-2" href="https://twitter.com/jayuk79" target="_blank">
			...
			<section class="container d-flex flex-column align-items-center">
				<section class="navbars">
					<nav class="mt-5 nav-buttons">
						...
						<button id="areaButton" type="button" class="button converter-button" data-converter="area">Area</button>
					...
					<nav class="mt-5 nav-dropdown">
						<select name="" id="converter-select-dropdown">
							<option id="lengthOption" type="button" class="button converter-option" data-converter="length">Length
							</option>
							<option id="areaOption" type="button" class="button converter-option" data-converter="area">Area</option>
							<option id="temperatureOption" type="button" class="button converter-option" data-converter="temp">
								Temperature</option>
							<option id="weightOption" type="button" class="button converter-option" data-converter="weight">Weight
							</option>
						</select>
					</nav>
				</section>
					...
					<section class="form-container" role="form" class="">
						<form>
							<div class="form-group">
								<input class="form-control mb-2 unitOutput" type="text" maxlength="30" id="lengthUnitOutput"
									placeholder="Result" disabled>
								<input class="form-control unitInput" maxlength="30" type="text" id="lengthUnitInput"
									onkeyup="javascript:convert(this.id);" data-unit="length" placeholder="Enter number to convert">
							</div>
							<div class="row">
								<div class="col-sm px-3">
									<label for="lengthConvertFrom">From: </label>
									<select class="form-control unitSelect" name="lengthConvertFrom" id="lengthConvertFrom"
				...
				<article id="areaConverter" class="card mt-3 py-3 px-0 px-sm-2 converter">
					...
					<section class="form-container" role="form" class="">
						<form>
							<div class="form-group">
								<input class="form-control mb-2 unitOutput" type="text" maxlength="30" id="areaUnitOutput"
									placeholder="Result" disabled>
								<input class="form-control unitInput" maxlength="30" type="text" id="areaUnitInput"
									onkeyup="javascript:convert(this.id);" data-unit="area" placeholder="Enter number to convert">
							</div>
							<div class="row">
								<div class="col-sm">
									<label for="lengthConvertFrom">From: </label>
									<select class="form-control unitSelect" name="areaConvertFrom" id="areaConvertFrom" size=""
										onchange="javascript:convert('areaUnitInput');">
								...
								<div class="col-sm">
									...
									<select class="form-control unitSelect" name="areaConvertTo" id="areaConvertTo" size=""
										onchange="javascript:convert('areaUnitInput');">
				...
				<article id="tempConverter" class="card mt-3 py-3 px-0 px-sm-2 converter">
					...
					<section class="form-container" role="form" class="">
						<form>
							<div class="form-group">
								<input class="form-control mb-2 unitOutput" type="text" maxlength="30" id="tempUnitOutput"
									placeholder="Result" disabled>
								<input class="form-control unitInput" maxlength="30" type="text" id="tempUnitInput"
									onkeyup="javascript:convert(this.id);" data-unit="temp" placeholder="Enter number to convert">
							</div>
							<div class="row">
								<div class="col-sm">
									<label for="lengthConvertFrom">From: </label>
									<select class="form-control unitSelect" name="tempConvertFrom" id="tempConvertFrom" size=""
										onchange="javascript:convert('tempUnitInput');">
								...
								<div class="col-sm">
									<label for="lengthConvertFrom">To: </label>
									<select class="form-control unitSelect" name="tempConvertTo" id="tempConvertTo" size=""
										onchange="javascript:convert('tempUnitInput');">
				...
				<article id="weightConverter" class="card mt-3 py-3 px-0 px-sm-2 converter">
					...
					<section class="form-container" role="form" class="">
						<form>
							<div class="form-group">
								<input class="form-control mb-2 unitOutput" type="text" maxlength="30" id="weightUnitOutput"
									placeholder="Result" disabled>
								<input class="form-control unitInput" maxlength="30" type="text" id="weightUnitInput"
									onkeyup="javascript:convert(this.id);" data-unit="weight" placeholder="Enter number to convert">
							</div>
							<div class="row">
								<div class="col-sm">
									<label for="lengthConvertFrom">From: </label>
									<select class="form-control unitSelect" name="weightConvertFrom" id="weightConvertFrom" size=""
								...
								<div class="col-sm">
									<label for="lengthConvertFrom">To: </label>
									<select class="form-control unitSelect" name="weightConvertTo" id="weightConvertTo" size=""
										onchange="javascript:convert('weightUnitInput');">
	...
	<footer class="footer mt-auto">
		...
		<p class="m-0">Copyright &copy; 2020 <?=$yearString?> Jason Robinson.</p>
	</footer>
